...
const Login = () => {
	...
	return (
		<>
			<div className="font-[sans-serif]" style={{ marginTop: "-100px" }}>
							...
							<form className="space-y-4" onSubmit={handleSubmit}>
								...
								<div className="flex flex-wrap items-center justify-between gap-4">
									...
									<div className="text-sm">
										<a href="jajvascript:void(0);" className="text-yellow-600 hover:underline font-semibold">
								...
								<div className="!mt-8">
									<button
										type="submit"
										className="w-full shadow-xl py-3 px-4 text-sm tracking-wide rounded-lg text-white bg-yellow-600 hover:bg-yellow-500 focus:outline-none"
									>
										Log in
									</button>
								</div>
