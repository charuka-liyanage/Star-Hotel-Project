					...
					<div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
						<div className="lg:col-span-2 max-md:order-1">
							...
							<form className="mt-8 max-w-lg" onSubmit={handleSubmit}>
								<div className="grid gap-4">
									<div>
										<input
											...
											className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-yellow-500 focus:bg-transparent outline-none"
											readOnly
										/>
									</div>
									<div>
									...
									<div className="grid grid-cols-2 gap-4">
										<div>
											<input
												type="number"
												placeholder="EXP."
												className="px-4 py-3.5 bg-gray-100 text-gray-800 w-full text-sm border rounded-md focus:border-yellow-600 focus:bg-transparent outline-none"
											/>
										</div>
										<div>
											<input
								...
								<button
									type="submit"
									className="mt-8 w-40 py-3.5 text-sm bg-yellow-600 text-white rounded-md hover:bg-yellow-700 tracking-wide"
								>
									Pay
								</button>
							</form>
						...
						<div className="bg-gray-100 p-6 rounded-md">
							...
							<ul className="text-gray-800 mt-8 space-y-4">
								<li className="flex flex-wrap gap-4 text-sm font-bold border-t-2 pt-4">
									Total <span className="ml-auto">Rs.{order.price}</span>
								</li>
							</ul>
						</div>
					</div>
